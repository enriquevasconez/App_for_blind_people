...
import EditDemandService from '../../demandService/editDemandService'
import PropuestasPresenter from '../../demandService/propuestasPresenter'

const Card = ({ dKey, dService, update }) => {
